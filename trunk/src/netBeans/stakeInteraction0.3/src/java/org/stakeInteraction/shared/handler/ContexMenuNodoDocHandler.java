 ...
 * @author grela
 */
public class ContexMenuNodoDocHandler extends ContexMenuNodoHandler {

   /* private Menu contexMenu;
    private ContenedorGrafo contenedorGrafo;
    private Nodo nodo;*/
   public ContexMenuNodoDocHandler(Menu contextMenu,ContenedorGrafo contenedorGrafo,Nodo nodo)
    {
      ...
      /* this.nodo=nodo;
       ...
       configurarContextMenu(asignarNodo);*/
    ...
    public void componentSelected(MenuEvent ce) {
        ...
        {
            contenedorGrafo.eliminarDoc(nodo);
        }
        else
        {
            if(ce.getItem()==(MenuItem)this.contexMenu.getItemByItemId("ASIGNAR_NODO"))
            {
