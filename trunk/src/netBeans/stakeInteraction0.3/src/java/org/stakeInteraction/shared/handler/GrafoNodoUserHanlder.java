...
public class GrafoNodoUserHanlder  implements MouseDownHandler,Serializable {

    private ContenedorGrafo contenedorGrafo;
    private Menu contextMenu;
    public  GrafoNodoUserHanlder(ContenedorGrafo contenedorGrafo,Menu contextMenu)
    {
...
//insert.setIcon(ICONS.add());
          ...
          ContexMenuNodoUserHandler contextMenuNodoHandler=new ContexMenuNodoUserHandler(contextMenu,contenedorGrafo,nodo);
